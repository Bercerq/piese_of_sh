...
interface SSPBillsTableProps {
  records: any[];
  user: AppUser;
}

const SSPBillsTable = (props: SSPBillsTableProps) => {
  const tableId: string = "sspbills-table";
  ...
  function metrics(): Metric[] {
    return [
      { col: 'name', label: 'SSP name', align: 'left' },
