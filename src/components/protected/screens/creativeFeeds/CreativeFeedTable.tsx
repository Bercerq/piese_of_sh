...
interface CreativeFeedTableProps {
  type: string;
  records: CreativeFeed[];
...
const CreativeFeedTable = (props: CreativeFeedTableProps) => {
  ...
  const getRows = () => {
    return props.records.map((o) => {
      const row = _.pick(o, ["id", "name", "description","writeAccess","rows"]);
...
export default CreativeFeedTable;