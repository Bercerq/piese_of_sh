...
import ReportTemplatesTable from "./PublisherReportTemplatesTable";
import { ScopeType } from "../../../../../client/schemas";
import ScopeDataContext from "../../../context/ScopeDataContext";
import { AppUser } from "../../../../../models/AppUser";
import UserContext from "../../../context/UserContext";
import PublisherReportTemplatePage, { ReportTemplatePageProps } from "./PublisherReportTemplatePage";
import BreadcrumbContext from "../../../context/BreadcrumbContext";

const PublisherReportTemplatesPageBody = () => {
  ...
  async function loadReportTemplates() {
    ...
    try {
      ...
      const reportTemplates = await Api.Get({ path: `/api/publisherReportTemplates/${scopeId}`, qs, signal: controller.current.signal });
  ...
  if (!error) {
    ...
    return <Switch>
      <Route path={`${match.path}/:templateId`}>
        <PublisherReportTemplatePage {...templateProps} />
      </Route>
            ...
            <div className="card mb-2">
              ...
              <div className="pull-right">
                {rights.MANAGE_REPORT_TEMPLATES &&
                  <Button variant="primary" size="sm" className="mr-2" onClick={() => { history.push(`/publisherreporttemplates/${scope}/${scopeId}/-1`) }}><FontIcon name="plus" /> ADD TEMPLATE</Button>}
...
export default PublisherReportTemplatesPageBody;