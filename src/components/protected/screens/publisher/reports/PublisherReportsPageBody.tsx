...
import PublisherReportsTable from "./PublisherReportsTable";
import PublisherReportInstancesModal from "./PublisherReportInstancesModal";
import PublisherReportModal from "./PublisherReportModal";
import PublisherReportShareModal from "./PublisherReportShareModal"
...
const ReportsPageBody = () => {
  ...
  async function loadReports() {
    ...
    try {
      ...
      const results = await Api.Get({ path: `/api/publisherreports/${scopeId}`, qs, signal: controller.current.signal });
