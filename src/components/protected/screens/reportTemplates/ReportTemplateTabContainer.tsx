...
import ReportTabFigureContainer from "./ReportTabFigureContainer";
...
const ReportTemplateTabContainer = (props: ReportTemplateTabContainerProps) => {
  ...
  return <div className="card mb-3 mt-3">
    ...
    {
      figures.map((figure, i) => <ReportTabFigureContainer
...
export default ReportTemplateTabContainer;